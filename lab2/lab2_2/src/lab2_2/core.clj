...
(defn calc-integral-graphic-lazy [func integration-step graphic-step end-x]
  (map (integration-operator func integration-step) (range 0 end-x graphic-step)))
...
(defn calc-integral-graphic-no-opti [func integration-step graphic-step end-x]
  (map (integration-operator-no-opti func integration-step) (range 0 end-x graphic-step)))
